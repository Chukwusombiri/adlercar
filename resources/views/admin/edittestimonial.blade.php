            ...
            <form method="POST" action="{{route('admin.testimonials.update',[$testimonial->id])}}" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('testifier') is-invalid @enderror" id="testifier" name="testifier" value="{{old('testifier') ?? $testimonial->name}}" required>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea rows="4" type="text" class="form-control @error('testimony') is-invalid @enderror" id="testimony" name="testimony" required >{{old('testimony') ?? $testimonial->testimony}}</textarea>
